...
func (ob *OpenAIBackend) Generate(ctx context.Context, req GenerateRequest) (*GenerateResponse, error) {
...
func (ob *OpenAIBackend) Chat(ctx context.Context, req ChatRequest) (*ChatResponse, error) {
