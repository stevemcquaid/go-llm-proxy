...
func (ab *AnthropicBackend) Generate(ctx context.Context, req GenerateRequest) (*GenerateResponse, error) {
...
func (ab *AnthropicBackend) Chat(ctx context.Context, req ChatRequest) (*ChatResponse, error) {
